...
$('.team_slider-prev').on('click', function name(e){
  e.preventDefault()
  $('.team_slider').slick('slickPrev'
  )
})
$('.team_slider-next').on('click', function name(e){
    e.preventDefault()
...
$('.testimonials_arrow_prev').on('click', function name(e){
  e.preventDefault()
  $('.testimonials_slider').slick('slickPrev'
  )
})
$('.testimonials_arrow_next').on('click', function name(e){
    e.preventDefault()
    $('.testimonials_slider').slick('slickNext'
    )
})
// Аккардеон, все части открыты
...
// Аккардеон, открыта только 1 часть
$('.program_acc-link').on('click', function (e) {
  e.preventDefault()
